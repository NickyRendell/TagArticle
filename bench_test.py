...
def categorise_title_excerpt(ArticleText):
    ...
    #Load the .env file
    load_dotenv(dotenv_path=r'C:\Users\charl\Dropbox\Dev\article\.env')
    ...
    content = f"###Categorise Article accoring to user needs###\n{EngUserNeeds}\n\n###Instructions###\nYou are a newspaper editor, given the above descriptions of the different user needs categories, return just one of categories that best applies to the following article title and excerpt: \n{ArticleText}\n"
